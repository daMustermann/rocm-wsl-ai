...
echo "* The start script now automatically applies the following ROCm-optimized flags: --use-rocm, --skip-torch-cuda-test, --no-half, --no-half-vae"
...
echo "  --medvram                  (if you have low VRAM)"
echo ""
